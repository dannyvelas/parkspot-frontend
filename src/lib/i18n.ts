...
function initDictionary(seedLocale: string) {
  dictionary.set({
    en: {
      ...
      rulesName: "Rules",
      rule0: 'Permits can be at most 15 nights.',
      rule1: 'A resident can create at most two permits that will be active on the same night.',
      rule2: 'A resident can give out a maximum of 15 nights worth of parking permits per year.',
      rule3: 'A car can have at most one active permit on a given night.',
      rule4: 'A car can be granted a maximum of 15 nights worth of parking permits per year.',
    },
    es: {
      ...
      rulesName: "Reglas",
      rule0: 'Los permisos pueden ser de máximo 15 noches.',
      rule1: 'Un residente puede crear como máximo dos permisos que estén activos la misma noche.',
      rule2: 'Un residente puede otorgar un máximo de 15 noches en permisos de estacionamiento por año.',
      rule3: 'Un carro puede tener como máximo un permiso activo en una noche determinada.',
      rule4: 'A un carro se le pueden otorgar como máximo 15 noches en permisos de estacionamiento por año',
    },
